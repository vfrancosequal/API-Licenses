...
module.exports = {
  ...
  encryptString:function(plaintext, password) {
    try{
      ...
      let ciphertextAndNonceAndSalt = Buffer.concat([ salt, Crypto.encrypt(Buffer.from(plaintext, "utf8"), key) ]);
  ...
  decryptString:function(base64CiphertextAndNonceAndSalt, password) {
    try{
      // Decode the base64.
      ...
      return Crypto.decrypt(ciphertextAndNonce, key).toString("utf8");
    }catch(err){
  ...
  encrypt:function(plaintext, key) {
   ...
   decrypt:function(ciphertextAndNonce, key) {
